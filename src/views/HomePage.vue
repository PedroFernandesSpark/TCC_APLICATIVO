      ...
      <ion-grid>
        ...
        <ion-row class="ion-justify-content-center ion-margin-top">
          <ion-col size="6" size-md="4">
            <ion-button expand="block" color="success" v-if="!isMeasuring" @click="startMeasurement">
              Iniciar Medição
            </ion-button>
            <ion-button expand="block" color="danger" v-if="isMeasuring" @click="stopMeasurement">
              Parar Medição
            </ion-button>
          </ion-col>
        </ion-row>
  ...
  methods: {
    async startMeasurement() {
      ...
      this.measurementInterval = setInterval(async () => {
        ...
        if (chart) {
          ...
          this.$nextTick(() => this.convertChartsToImages());
        }
      }, 1000);
    },
    ...
    async enviarFlagEDesconectar() {
      ...
      try {
        ...
        const stopFlag = encoder.encode('STOP');
